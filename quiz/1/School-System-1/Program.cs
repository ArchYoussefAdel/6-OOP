...
class Program
{
    static void Main(string[] args)
    {
        ...
        for (int i = 0; i < numTeachers; i++)
        {
            ...
            string teacherGender = Console.ReadLine().ToLower();
            Console.Write("Subject assigned (math, arabic, science, english): ");
            string teacherSubject = Console.ReadLine().ToLower();
        ...
        for (int i = 0; i < numStudents; i++)
        {
            ...
            Console.Write("Gender (male/female): ");
            string studentGender = Console.ReadLine().ToLower();
            Console.Write("Subject (math, arabic, science, english): ");
            string studentSubject = Console.ReadLine().ToLower();
            ...
            {
                student.Teachers[0] = matchingTeacher;
            }
            students[i] = student;
        }
